...
<body>
    ...
    <script>
    var conn = new WebSocket('ws://210.89.191.220:8282');
    var client = {
        user_id: <?php echo $user_id; ?>,
		//user_nickname: '<?php echo $user_nickname; ?>',
        recipient_id: null,
        message: "입장하셨습니다."
    };
    ...
    conn.onmessage = function(e) {
        ...
        if (data.message) {
            $('#messages').append(data.user_id + '님 : ' + data.message + '<br>');
        }
    };
